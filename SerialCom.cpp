...
BOOL CSerialCom::GetCommunicationTimeouts(){
...
m_CommTimeouts.WriteTotalTimeoutMultiplier =WriteTotalTimeoutMultiplier;
		...
		if(m_bPortReady ==0){
MessageBox("SetCommTimeouts function failed","Com Port Error",MB_OK+MB_ICONERROR);
		CloseHandle(hComm);
		return false;}
		return true;
}
...
void CSerialCom::setDTR()
{
	EscapeCommFunction(hComm, SETDTR);
return;
}

void CSerialCom::clearDTR()
{
